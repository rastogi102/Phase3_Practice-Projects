...
namespace WebApplication1.Models
{
    ...
    {
        string connectionString = "data source=DESKTOP-MFQ8M0P;initial catalog=SSchool;TrustServerCertificate=True;integrated security=True;MultipleActiveResultSets=True;";
